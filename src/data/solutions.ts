...
export const SOLUTIONS: SolutionOrg[] = [
  {
    ...
    "summary": "1차 선정이 절실하신 분들만 들어오세요",
    "description": "🏆 **모두의창업 인기 AI 솔루션 기업 핸디컴퍼니** 🏆 🎉 아이디어 심사에 통과하신 분들 진심으로 축하드립니다. 기쁨도 잠시 이제는 1라운드라는 벽을 넘어야 됩니다. 멘토링을 귀 기울여 듣고 열정만 보이면 되는 1라운드 **🤔 과연 그것만으로 충분할까요?** 🔥 **열정은 어떻게 측정되는 걸까요?** 간단합니다. 여러분이 써서 제출한 **아이디어를 실체화**하고 **시장성을 테스트**하는 것 그것이 창업 씬에서의 열정이자 멘토링의 목적입니다. ✅ 그래서 핸디독스에서 준비했습니다. 📋 제출하신 사업계획서를 기반으로 **1. 🛠️ 고퀄리티 MVP 산출** **2. 📣 시장 반응 검증을 위한 마케팅** **3. 📊 결과물 보고서** 전부 올인원으로 진행해드립니다. **❓ 너네가 누군데?❓** **🏢 \"사업 고민에 마침표를 찍다\"** **핸디컴퍼니는 위의 사명 아래** **창업의 전 과정을 함께하는** **IT 벤처 기업입니다",
  ...
  },
  {
    ...
    "summary": "창업가의 아이디어를 최고 전문가 수준의 심층 전략, PPT, 사업계획서로 완성해 주는 AI 에이전트 솔루션",
    "description": "**창업가의 아이디어를 최고 전문가 수준의 심층 전략, PPT, 사업계획서로 완성해 주는 AI 에이전트 솔루션** 모달리(Modaly)는 ChatGPT, Claude, Gemini의 최신 플래그십 AI 모델을 적재적소에 활용하여 AI 채팅 및 에이전틱 워크플로우의 완성도를 극대화했습니다. 여기에 글로벌 탑티어 컨설팅, IB/PE/VC, 대기업, 테크 스타트업의 베스트 프랙티스와 성공 노하우를 결합하여, 창업가분들의 세상을 바꿀 아이디어를 최고 전문가 수준의 심층 전략, PPT, 사업계획서로 완성해 드립니다. 압도적인 결과물의 차이, 지금 모달리에서 직접 경험해 보세요. 성공적인 창업의 시작을 함께하겠습니다. **[1] 아이디어 고도화 위한 심층 채팅** ChatGPT, Claude, Gemini의 최신 플래그십 AI 모델을 사용하여, 창업가의 아이디어에 맞게 해당 분야 최고 전문가 수준의 사업 전략과 실행 계획을 수립합니다. 답변의 구체적 논리를 제공하고, 명확한 출처 제공을",
    ...
    "techEvidence": "GPT, ChatGPT, Claude, Gemini, AI 모델, AI 에이전트, 에이전트, 리서치, 데이터 분석, 분석",
    "priceText": [
    ...
    "services": [
      {
        ...
        "techEvidence": "GPT, ChatGPT, Claude, Gemini, AI 모델, AI 에이전트, 에이전트, 리서치, 데이터 분석, 분석, 리포트, 보고서"
      }
    ]
  },
  {
    ...
    "summary": "3분 만에 AI로 홈페이지 완성, 시장성 검증까지, '데이터 방패'를 장착해 내 아이디어를 지키고 고도화하세요 - 바이브 코딩 노코드로 3분 만에 랜딩 페이지를 띄워, 심사위원을 설득할 수요조사 데이터(보험)를 확보하세요.",
    ...
    "techEvidence": "GPT, Claude, Gemini, 시장조사, 노코드, 랜딩페이지, 랜딩, 홈페이지, MVP, DB",
    "priceText": [
    ...
    "pricingSortRank": 1,
    "benefits": [
      "🫡예선 통과자 대상: MVP 전문가의 1:1 컨설팅 혜택 제공",
      "1️⃣멀티모델 AI 6개월 제공: Chat GPT, Gemini, Claude를 선택해서 사용할 수 있는 이용권",
      "2️⃣멀티모델 AI 1개월 추가 제공: 패스해커 레이더+서포터 동시 사용 시 1개월 추가 제공 [9만원 상당]",
      "베이직: 사업계획서 생성"
    ],
    ...
    "services": [
      ...
      },
      {
        "id": 1216,
        "name": "패스해커 서포터",
        "summary": "밤새 서류 쓰세요? 지원금 타내는 합격 족보에 내 아이디어만 이식하세요 - 탈락해 수천만 원을 날리기 전, '글쓰기 AI'로 심사위원의 공격을 완벽히 방어할 합격 보험을 완성하십시오.",
        "website": "https://passhacker.com/modoo",
        "keywords": [
  ...
  },
  {
    ...
    "summary": "1 Round 통과를 간절히 원하는분들께 추천드립니다. 이번 라운드는 멘토링이 핵심입니다. 1라운드 제출용 멘토링 보고서를 고도화 해드립니다. 사업계획서의 품질을 높일 수 있는 AI 기반 사업전략 분석 딥리서치 솔루션",
  ...
  },
  {
    ...
    "logo": "https://xgsaqqpairap3855818.gcdn.gov-ntruss.com/image/service/188775/bbdb6eea876f4dcc821cb45dfd18a1bf.png",
    "summary": "아이디어를 웹 앱(MVP)으로 만들어드립니다",
    "description": "사업계획서에 작동하는 웹 앱(MVP)을 더하세요. **🔗 실제 작동하는 데모 — 지금 바로 열어보세요** **매칭·플랫폼 아이디어라면** · 우리동네 고수 (전문가 견적 매칭) → [https://gosu.foundry.ai.kr](https://gosu.foundry.ai.kr) · 우리동네 (동네 커뮤니티) → [https://our-town.foundry.ai.kr](https://our-town.foundry.ai.kr) **예약·서비스업 아이디어라면** · 예약노트 (1인 샵 예약·고객관리) → [https://yeyak.foundry.ai.kr](https://yeyak.foundry.ai.kr) **AI·데이터 분석 아이디어라면** · 리뷰읽어주는AI (리뷰 자동 분석 리포트) → [https://review-ai.foundry.ai.kr](https://review-ai.foundry.ai.kr) **제품·판매 아이디어라면** · 스마트몰 (쇼핑몰)",
    ...
    "techEvidence": "AI에이전트, 에이전트, 바이브코딩, 홈페이지, MVP, 시제품, 데이터 분석, 분석, 리포트, 예약",
    "priceText": [
    ...
    "recommendation": "기술·개발 분야의 아이디어 검증 단계에서 사업계획서, 홈페이지 근거가 필요한 무료 혜택까지 함께 확인하고 싶은",
    "followerCount": 688,
    "likeCount": 717,
    "hasFreeBenefit": true,
    "hasPrice": true,
    ...
    "services": [
      {
        ...
        "techEvidence": "AI에이전트, 에이전트, 바이브코딩, 홈페이지, MVP, 시제품, 데이터 분석, 분석, 리포트, 예약, DB"
      }
    ]
  },
  {
    ...
    "logo": "https://xgsaqqpairap3855818.gcdn.gov-ntruss.com/image/service/117714/9c96685e236842b196ff66de74fc92ca.png",
    ...
    "pricingSortRank": 2,
    "benefits": [
      "🎯 2라운드 진출자(300명) 대상: 브랜드 전문가의 1:1 컨설팅 혜택 제공",
  ...
  },
  {
    ...
    "summary": "다음 라운드, 15초 영상으로 먼저 설득하세요",
    ...
    "techEvidence": "GPT, AI 에이전트, 에이전트, 랜딩, 분석, 이미지, 영상 생성, 자동화",
    "priceText": [
      "프로 / 월 구독 / 149,000원"
    ],
    "minPrice": 149000,
    ...
    "pricingSortRank": 1,
    "benefits": [
      "가입시 10 크레딧 제공: 빠나나 서비스를 테스트 해보실 수 있습니다."
    ],
  ...
  },
  {
    ...
    "summary": "소상공인 리뷰·콘텐츠·매장 관리를 AI로 하는 솔루션 입니다.",
    "description": "**AI와 기술로 더 나은 일상을 만드는 팀입니다.** 퍼스트플루크는 기능을 많이 담는 서비스보다, 사람들이 오래 쓰는 경험을 고민합니다. 복잡한 기술을 전면에 드러내는 대신, 사용자가 편하게 이해하고 쓸 수 있도록 구조와 흐름을 설계합니다. AI, 콘텐츠, 자동화를 기반으로 다양한 디지털 제품과 서비스를 기획하고 개발합니다. 아이디어 단계부터 실제 사용까지 이어지는, 실행 중심의 프로덕트를 만듭니다. **기술 자체보다 ‘왜 필요한가’와 ‘어떤 경험을 남기는가’를 먼저 생각합니다.**",
    ...
    "pricingSortRank": 1,
    "benefits": [],
    "recommendation": "IR/발표자료, 자동화 결과물로 첫 고객 반응을 빠르게 확인하려는 플레이스 해줘 (place-haejo) 같은 서비스가 필요한 팀",
    "followerCount": 112,
    "likeCount": 400,
    "hasFreeBenefit": false,
    "hasPrice": true,
    ...
    "services": [
      ...
      },
      {
        ...
        "summary": "콘텐츠 기획부터 제작·성과분석·수익화까지 지원하는 AI 콘텐츠 솔루션",
        ...
        "techEvidence": "랜딩, 분석, 자동화"
      },
      {
        "id": 1455,
        "name": "Legalize KR",
        "summary": "법령 개정 이력과 변경 내용을 AI로 분석·비교하는 법령 데이터 솔루션",
  ...
  },
  {
    ...
    "summary": "사업 아이템을 ‘AI 지식 챗봇’으로 구현하는 지식 디자인 서비스🚀",
    "description": "## 창업팀의 아이디어가 더 선명하게 전달될 수 있도록, 일루니가 함께합니다 일루니는 인공지능과 그래픽스 기술을 기반으로, 사람들의 상상과 아이디어를 실제 서비스로 구현해 온 AI 기술 기업입니다. 창업팀에게 가장 중요한 것은 좋은 아이디어를 갖는 것에서 끝나지 않습니다. 그 아이디어를 누구에게, 왜 필요한지, 어떤 근거로 실행 가능한지, 어떻게 성장시킬 수 있는지 설득력 있게 설명해야 합니다. 일루니는 AI 기술을 단순한 자동화 도구가 아니라, 사람의 생각과 아이디어를 더 잘 표현하고, 정리하고, 확장하는 기술로 바라봅니다. 모두의창업에 참여하는 창업팀이 자신의 사업 아이템을 더 명확하게 설명하고, 더 신뢰도 있게 전달하며, 다음 단계로 성장할 수 있도록 일루니의 기술과 경험을 제공합니다. --- ## 일루니는 어떤 회사인가요? 💡 일루니는 **AI에서 융합현실까지 이어지는 기술을 연구하고, 이를 실제 서비스로 구현하는 기업**입니다. 사람 검출, 모션캡처, 행동",
    ...
    "techEvidence": "LLM, 생성형, AI에이전트, 에이전트, 응답, 경쟁사, RAG, GraphRAG, 지식그래프, 분석",
    "priceText": [
    ...
    "benefits": [
      ...
      "2+2 혜택: 2개월 구독 결제 시 2개월 무료 이용",
      "Free: 캐릭터 1개, 월 메시지 200, 동시 접속 5명, 기본 임베드(MoiiMe 표기 포함), 커뮤니티 지원"
    ],
    "recommendation": "경영·관리 분야의 아이디어 검증 단계에서 사업계획서, IR/발표자료 근거가 필요한 무료 혜택까지 함께 확인하고 싶은",
    "followerCount": 72,
    "likeCount": 400,
    ...
    "services": [
      {
        ...
        "techEvidence": "LLM, 생성형, AI에이전트, 에이전트, 응답, 경쟁사, RAG, GraphRAG, 지식그래프, 분석, 이미지 생성, 이미지"
      },
      {
        "id": 1088,
        "name": "MoiiMe",
        "summary": "브랜드와 서비스를 3D AI 캐릭터로 표현하는 비주얼 AI 에이전트 제작 서비스🎭",
        ...
        "techEvidence": "LLM, 생성형, AI에이전트, AI 에이전트, 에이전트, 응답, 경쟁사, RAG, 분석, 이미지 생성, 이미지, 사진"
      }
    ]
  },
  {
    ...
    "summary": "AI를 똑똑하게 쓰게 해주는 AI - 막연한 아이디어를 BRD·PRD·TRD 문서와 업무 태스크로 자동 정리, Claude·Cursor 바이브코딩과 직접 연결해 기획부터 개발까지 한 흐름에 이어주는 AI 솔루션",
  ...
  },
  {
    ...
    "summary": "사업 성공을 위한 남다른 전략이 필요하다면?",
  ...
  },
  {
    ...
    "website": "https://xn--9i1b674cwc38r6pa.com/",
  ...
  },
  {
    ...
    "summary": "[월 정액 무제한 사용] STT·TTS·OCR·LLM·임베딩·리랭커·이미지·음악생성 GPU 기능 앱은 AI로 딸깍, GPU 사용은 \"빌쇼크\" 걱정 없이 무제한. 테크 창업 개발자를 위한 AI API 오마카세. 🍣",
    ...
    "techEvidence": "LLM, GPT, RAG, 이미지, STT, TTS, API, 인프라, GPU",
    "priceText": [
    ...
    "pricingSortRank": 1,
    "benefits": [
      "Playground 무료 체험형: 다양한 AI API 모델을 실시간으로 테스트할 수 있는 API 체험존을 제공"
    ],
    "recommendation": "LLM/생성형AI, RAG/지식검색 기술 방식을 활용해 아이디어를 제품 형태로 보여줘야 하는 AI API 오마카세 같은 서비스가 필요한 팀",
    "followerCount": 141,
    "likeCount": 162,
    "hasFreeBenefit": true,
    "hasPrice": true,
  ...
  },
  {
    ...
    "summary": "같은 상품, 채널마다 다른 마진 → 어디서 남는지 1초 만에 찾기",
  ...
  },
  {
    ...
    "summary": "모든 지원사업 한글(hwp, hwpx) 양식 대응 사업계획서AI",
  ...
  },
  {
    ...
    "summary": "글로벌 IT 창업가 10,000명이 사용하는 기획 AI - APP / WEB / SaaS 서비스를 함께 만들어요.",
    "description": "**글로벌 IT 창업가 10,000명이 사용하는 소프트웨어 기획 AI** 매니패스트입니다 🐢 앱을 개발하기 이전, 보다 자세하게 기획을 완성해야 **좋은 프로덕트**가 나옵니다. 국내 기업 1,000개 이상, **대기업 20개사, 상장사 유니콘 19개사, 대학 40여곳**에서 이용 중 이에요. 대화만으로 PRD부터 와이어프레임까지, 모든 기획을 하나의 캔버스에서 완성하고 **코딩 도구와 연동**하세요. **APP / WEB / SaaS / 플랫폼**을 개발하려고 하시는분들께 추천드립니다. 매니패스트는 **누구나 무료로 체험가능**하니, 신중하게 체험해보시고 결제하세요. 자신있습니다 🙌 **[ 매니패스트 주식회사🐢 ]** - 스파크랩 / 라구나인베스트먼트 투자 유치, 누적 매출 50억원 - 2025 팁스(TIPS) R&D 프로그램 선정 - 창업도약패키지(딥테크) / 글로벌창업사관학교 7기 선정 - 신용보증기금 Start-up NEST 13기 선정 - 엔비디아",
  ...
  },
  {
    ...
    "summary": "두 달 뒤 빈손이 되지 않게, 완주하신 분과는 그 뒤로 6개월을 더 함께합니다 🌙",
    "description": "🌱 두 달이 끝나도, 완주하신 분과는 6개월을 더 함께합니다 (1라운드 목표 달성은 2라운드 진출이나 2개월 완주를 말합니다) 선정되면 두 달은 정부 크레딧으로 0원입니다. 첫 고객 모으는 일부터 페이지와 콘텐츠, AI평가단 45개 관점 진단까지, 사장님이 혼자 짊어지던 걸 옆에서 같이 듭니다 📌 발표 직후 60일, 대부분 똑같이 막막해집니다. 무엇을 매주 해야 2라운드에서 살아남는지. 다음 라운드 리포트 한 장은 시작일 뿐입니다. 랜딩 1장·수요조사 1장이 아니라, 60일 전체를 점수로 남겨야 합니다. 들로우에이아이는 60일에 두 명의 AI 동료를 붙입니다. 운영전략 AI와 마케팅 AI가 매주 같이 뜁니다. 핵심은 생성이 아니라 반복입니다. 들어온 답변을 매주 받아보고 다시 쓰며, 점수로 기록합니다. 60일 뒤 손에 남는 건 말이 아니라 기록입니다. 2라운드 제출용 사업 리포트와 멘토 제출 리포트.",
    ...
    "techEvidence": "랜딩페이지, 랜딩, 홈페이지, 웹페이지, 리포트",
    "priceText": [
      "베이직 요금제 / 월 구독 / 290,000원"
    ],
    "minPrice": 290000,
    "pricingKind": "fixed",
    "pricingSortRank": 1,
    ...
    "recommendation": "경영·관리 분야의 아이디어 검증 단계에서 IR/발표자료, 카드뉴스 근거가 필요한 무료 혜택까지 함께 확인하고 싶은",
    "followerCount": 95,
    "likeCount": 103,
    "hasFreeBenefit": true,
    "hasPrice": true,
  ...
  },
  {
    ...
    "description": "우수스타트업 대상|NICE평가정보가 엄선한 B2B 솔루션|검증된 사업자 **디엑스아이알 주식회사 | DXIR Co., Ltd.** - **2026년 우수 스타트업 대상(['전략 실행 자동화 플랫폼' 디엑스아이알, '우수스타트업' 선정 - 머니투데이)](https://www.mt.co.kr/industry/2026/04/16/2026041609534683684)** - **NICE평가정보가 엄선한 B2B 솔루션 기업([https://www.nicebizinfo.com/](https://www.nicebizinfo.com/))** - **필요하신 리서치 서비스가 있으신 경우 메일([support@dxir.co](mailto:support@dxir.co))로 알려주시면 서비스에 추가해 드립니다.** - **모든 리서치/전략 서비스에 대해 라이브 데모(Live Demo - 실제와 똑같이 만들어 놓은 데모화면)가 있습니다. 로그인을 하지 않으셔도 어떤 서비스인지 확인하실 수 있으니 방문해",
    ...
    "techEvidence": "GPT, Claude, 생성형, AI 모델, 시장조사, 리서치, 경쟁사, 시장 규모, 홈페이지, 분석",
    "priceText": [
    ...
    "services": [
      {
        ...
        "techEvidence": "GPT, Claude, 생성형, AI 모델, 시장조사, 리서치, 경쟁사, 시장 규모, 홈페이지, 분석, 보고서, 자동화"
      }
    ]
  },
  {
    ...
    "services": [
      ...
      },
      {
        "id": 1458,
        "name": "포스팅해",
        "summary": "사진 한장으로 광고 이미지 자동 생성해 드립니다.",
  ...
  },
  {
    ...
    "description": "주식회사 웜블러드는 기업용 AI 워크스페이스 **'모노클AI(Monocle AI)'** 를 운영하는 AI 전문 기업입니다. 2022년 설립 이후 부동산 개발·B2B 금융 플랫폼 '딜매치', 산업안전 위험성평가 AI '세이프티스냅' 등을 직접 기획·개발·운영하며 산업 현장에 필요한 AI 솔루션을 만들어왔고, 그 경험을 토대로 모든 산업과 직무에서 활용 가능한 범용 AI 워크스페이스 모노클AI를 개발했습니다. **모노클AI는 어떤 서비스인가요?** 모노클AI는 **ChatGPT, Claude, Gemini, Perplexity 등** **주요 생성형 AI를 하나의 워크스페이스에서 선택·비교·활용할 수 있는 기업용 AI SaaS**입니다. 여러 AI 서비스에 각각 가입하고 화면을 오갈 필요 없이, 하나의 계정 안에서 목적에 맞는 모델을 골라 사용할 수 있습니다. 단순한 챗봇이 아니라 **문서 작성, 자료 분석, 팀 협업, 업무 자동화까지 실제 결과물을 만들어내는 AI 업무 환경**이라",
  ...
  },
  {
    ...
    "summary": "글로벌 이미지/영상 AI 모델 50여가지와 AI 템플릿·스톡·아바타까지 제공하는 콘텐츠 AI 플랫폼",
    "description": "㈜지로는 AI 기반 이미지·영상 생성 플랫폼 “드롭샷 AI (Dropshot AI)”를 운영하는 콘텐츠 AI 스타트업으로, 생성형 AI 시대에서 기업과 크리에이터들이 겪고 있는 콘텐츠 제작의 높은 진입장벽과 비효율 문제를 해결하고자 설립되었습니다.",
    ...
    "techEvidence": "생성형, AI 모델, 이미지, 영상 생성",
    "priceText": [
    ...
    "recommendation": "영상, 이미지를 빠르게 만들고 고객 모집을 시작하려는 드롭샷 AI(Dropshot AI) 같은 서비스가 필요한 팀",
    "followerCount": 43,
    "likeCount": 57,
    "hasFreeBenefit": true,
    "hasPrice": true,
  ...
  },
  {
    ...
    "description": "Enterprise형 AI 업무자동화 플랫폼 NOW AX 플랫폼 시리즈와 NOW AX Studio를 개발했습니다. 기업 업무 전 과정을 자율 실행하는 조직형 AI Agent 환경을 실현합니다. ￣￣￣￣￣￣￣￣￣￣￣￣￣￣￣￣￣￣￣￣￣￣￣￣￣￣￣￣￣￣￣￣￣￣￣￣￣￣￣ 💼 직원이 하던 반복 업무, 이제 AI가 대신합니다 \"말만 하세요. AI가 알아서 처리합니다.\" ❌ 이런 문제, 겪고 계신가요? ✅ IPNOW의 NOW AX가 해결합니다 경영 / 영업 / 생산관리 / R&D 등 300개 핵심 업무를 코딩 없이, 개발자 없이, 며칠 안에 자동화 📌 조직에 맞게 세팅 — 우리 회사 업무 구조 그대로 AI가 붙습니다 📌 조회 → 판단 → 실행까지 한 번에 — 중간에 사람 손 필요 없음 🏆 왜 IPNOW인가요? IPNOW NOW AX 기술 선행성 ｜Salesforce·SAP·MS보다 2년 앞선 원천기술 특허 보호｜국내·미국·PCT 37건 등록 도입 속도｜수 시간~수 일 내 구축 완",
    ...
    "pricingSortRank": 1,
    "benefits": [],
    "recommendation": "업무 자동화/API 기술 방식을 활용해 아이디어를 제품 형태로 보여줘야 하는 메가웍스 (Mega-works) 같은 서비스가 필요한 팀",
    "followerCount": 53,
    "likeCount": 31,
    "hasFreeBenefit": false,
    "hasPrice": true,
  ...
  },
  {
    ...
    "description": "### SF34를 소개합니다 ### SF34는 ++**좋은 아이디어가 실행되지 못하고 사라지는 문제를 해결하고자 시작한 스타트업**++입니다. 많은 예비 창업자와 초기 창업자는 아이디어를 가지고 있습니다. 하지만 아이디어가 실제 사업이 되기까지는 여러 장벽이 있습니다. 함께할 팀원을 찾기 어렵고, 내 아이디어가 시장에서 통할지 검증하기 어렵고, 제품으로 만들기 위한 기획과 개발 과정도 막막합니다. SF34는 이 간극을 줄이고자 합니다. 우리는 **누구나 자신의 아이디어를 실행까지 연결할 수 있어야 한다** 는 비전 아래, 아이디어를 가진 사람이 팀을 만나고, 시장을 검증하고, 실제 제품으로 나아갈 수 있는 도구를 만들고 있습니다. 현재 SF34는 두 가지 서비스를 운영하고 있습니다. [렛플](https://letspl.me/)은 아이디어를 가진 사람들이 함께할 팀원과 프로젝트를 만날 수 있도록 돕는 팀원 매칭 플랫폼입니다. [Bunzee](https://bunzee.",
  ...
  },
  {
    ...
    "summary": "BaaS (Backend as a Service) 기반 AI Vibe-Coding 플랫폼 : \"생각을 입력하면, 사업이 시작됩니다\" 나만의 도메인을 제공하고, 랜딩페이지를 제작, 배포까지 완료합니다. - 모두의 창업, AiApp",
    "description": "## 1. 한 줄 정의 - 채팅 대화만으로 실제 운영 가능한 웹·앱을 만드는 BaaS 기반 AI 바이브 코딩 플랫폼 기업 --- ## 2. 핵심 서비스: AiApp - 아이디어를 채팅으로 설명하면 AI가 기획, UI, 기능, DB를 자동 생성하여 즉시 배포 가능한 서비스 완성 - 프론트엔드 + 백엔드 + 관리자 기능까지 하나의 플랫폼에서 통합 제공 - 코딩 지식 불필요 — 비개발자 창업자도 직접 제작 및 운영 가능 --- ## 3. 바이브코딩이란 - 코드를 직접 작성하지 않고, 만들고 싶은 서비스를 AI에게 설명하며 대화로 결과물을 만들어가는 개발 방식 - 창업 초기 아이디어를 빠르게 구현하고 시장 반응을 검증하는 데 적합 - AiApp은 이 바이브코딩 방식을 비개발자도 사용할 수 있도록 설계한 플랫폼 --- ## 4. 기존 방식과의 차이 ### 노코드 툴 - 화면(랜딩페이지) 제작에 강점이 있으나, 백엔드 기능은 별도 연동 필요 ### 외주 개발 - 완성",
    "website": "https://aiapp.help",
    "email": "mbaas.help@gmail.com",
    "contact": "",
    ...
    "techEvidence": "AI에이전트, 에이전트, 노코드, 바이브코딩, 랜딩페이지, 랜딩, 홈페이지, MVP, 대시보드, 자동화",
    "priceText": [
    ...
    "services": [
      {
        ...
        "techEvidence": "AI에이전트, 에이전트, 노코드, 바이브코딩, 랜딩페이지, 랜딩, 홈페이지, MVP, 대시보드, 자동화, 연동, DB"
      }
    ]
  },
  {
    "id": 736,
    "name": "가장 쉬운 AI홍보자동화, 디자인,이미지자동화 및 AI MVP제공 - 로보엠디",
    "logo": "https://xgsaqqpairap3855818.gcdn.gov-ntruss.com/image/service/191799/248d2fb4a7d1436681ae04e9dd0d294d.png",
    "summary": "매일 홍보자동제작과 등록으로 사업성과를 보여주세요",
    "description": "**사진·컨텐츠 디자인부터 홍보글제작,인스타그램 자동홍보까지 한 번에!** 아이디어만 입력하세요. 홍보 콘텐츠 제작부터 인스타그램 등록까지 로보엠디가 한 번에 도와드립니다. 🎉 모두의창업 아이디어 심사 통과를 진심으로 축하드립니다. 이제는 좋은 아이디어를 더 많은 사람에게 보여줄 차례입니다. 로보엠디는 창업팀과 기업을 위한 **AI 콘텐츠 자동화솔루션**입니다. 생성AI로 이미지를 만들고, 수백 개 템플릿으로 디자인을 편집하고, 홍보 문구와 해시태그를 자동으로 만들고, 인스타그램 등록까지 자동화할 수 있습니다. --- ### 1. AI 디자인 생성AI로 홍보 이미지를 만들고 수백 개 디자인 템플릿으로 배너, 홍보배너, 썸네일, 피드 이미지를 편집·제작할 수 있습니다. **✅ AI 이미지 생성** **✅ 디자인 템플릿 선택** **✅ 디자인 편집** **✅ 배너 / 홍보배너 / 썸네일 제작** **✅ 다양한 홍보 이미지 제작** --- ### 2. AI 인스타그램",
    ...
    "techEvidence": "생성AI, AI 모델, MVP, 이미지 생성, 이미지, 사진, 자동화, API, 예약, 연동",
    "priceText": [
      "유/무료 혼합 / 200,000원",
    ...
    "pricingSortRank": 1,
    "benefits": [
      "무료체험: ✅ 홍보용 디자인 템플릿 제공 ✅ 생성AI 모델 이미지 제작✅ AI 이미지 자동제작✅ 브랜드 맞춤 홍보글 AI자동작성 ✅ 해시태그 자동 생성✅ 게시물 예약 등록✅ 컨텐츠자동제작등록",
      "무료체험: 14일간 무료사용"
    ],
    "recommendation": "기술·개발 분야의 아이디어 검증 단계에서 사업계획서, IR/발표자료 근거가 필요한 무료 혜택까지 함께 확인하고 싶은",
    "followerCount": 34,
    ...
    "services": [
      ...
      },
      {
        ...
        "summary": "🤖AI학습기능, AI 텍스트, AI 이미지 제작 API 및 AI설정 페이지 모두 제공",
        "website": "https://iclave.co.kr/aiapi",
        "keywords": [
          "AI 콘텐츠",
          "AI 텍스트 API제공",
        ...
        "techEvidence": "생성형, 생성AI, 노코드, 웹페이지, MVP, 이미지 생성, 이미지, 사진, 자동화, API, 예약, 연동"
      },
      {
        "id": 1301,
        "name": "로보엠디 AI 디자인",
        ...
        "techEvidence": "생성AI, MVP, 이미지 생성, 이미지제작, 이미지, 사진, 자동화, API, 예약, 연동"
      }
    ]
  },
  {
    ...
    "website": "https://oowa.ai",
    "email": "leo@homilabs.ai",
    "contact": "010-7266-2025",
  ...
  },
  {
    ...
    "summary": "Claude, GPT, Codex, Gemini, Seedance 등 다양한 AI 서비스의 API와 구독형 플랜(Max 포함)을 하나의 계정과 한 번의 결제로 통합 이용할 수 있는 AI 플랫폼입니다.",
    ...
    "services": [
      {
        ...
        "name": "빌링AI",
        "summary": "Claude, GPT, Codex, Gemini, Seedance 등 다양한 AI 서비스의 API와 구독형 플랜(Max 포함)을 하나의 계정과 한 번의 결제로 통합 이용할 수 있는 AI 플랫폼입니다.",
        "website": "https://xn--ai-9e0j63m.com/",
        "keywords": [
          "chat gpt",
          "Claude",
          "codex",
  ...
  },
  {
    ...
    "summary": "복잡한 백엔드 인프라 설정을 바이브코딩으로 빠르게 AI서비스를 구축하고 배포 할 수 있는 BaaS AI 입니다.",
    "description": "★★★서비스 이용 [https://gencow.com/modoo](https://gencow.com/modoo) 젠카우(Gencow)는 AI 앱 개발에 필요한 서버 · 데이터베이스 · 인증·AI연동을 하나의 플랫폼으로 통합 제공하는 AI백엔드 엔진 입니다. 개발 경험이 없는 예비 창업자도 AI 코딩 도구(Cursor, Claude 등)와 함께 사용하면 외주 없이 직접 서비스를 구축할 수 있습니다. 전문 인프라 엔지니어나 코딩 지식 없이도 상용화 수준의 AI 에이전트를 CLI 기반으로, 단 3분 만에 구축할 수 있는 올인원 AI 백엔드 엔진이자 서비스형 백엔드(BaaS)입니다. 단일 API 키와 통합 크레딧으로 다양한 대형언어모델(LLM)을 지원하며, RAG 파이프라인, 벡터 DB, 인증, 결제 등 필수 인프라를 통합 컴포넌트로 제공합니다. 명령어 한 줄로 로컬(PGlite)에서 상용(PostgreSQL)으로 즉시 전환되는 원커맨드 배포와 nsjail 샌드박스 보안을 통해 엔터프라",
    "website": "https://www.gencow.com",
    "email": "hello@spaceflo.io",
    "contact": "070-8080-0615",
  ...
  },
  {
    ...
    "email": "jekeun.moon@tripleauth.com",
    "contact": "",
  ...
  },
  {
    ...
    "summary": "온라인 판매를 위한 상품 상세페이지 1분 완성 AI 에이전트 - 상품 사진만 올리고, 내 상품에 최적화된 상품 상세페이지를 1분만에 만들어보세요",
    "description": "테르밋은 AI 에이전트 기술력을 바탕으로, 온라인 판매에 필요한 마케팅 콘텐츠를 제작하는 서비스 \"크리에이지\"를 운영하고 있습니다. 크리에이지는 상품 사진만 올리면 3분만에 내 상품에 최적화된 상품 상세페이지를 만들 수 있는 서비스입니다. [https://creazy.app](https://creazy.app) 에서 보다 자세히 확인해보세요",
    "website": "https://creazy.app",
    ...
    "recommendation": "이미지 결과물로 첫 고객 반응을 빠르게 확인하려는 크리에이지 같은 서비스가 필요한 팀",
    "followerCount": 17,
    "likeCount": 43,
    "hasFreeBenefit": true,
    "hasPrice": true,
  ...
  },
  {
    ...
    "description": "**(주)위커밋은 LLM 기반 정부지원사업 자동화 솔루션 'genDOC'을 개발·운영하는 AI 스타트업입니다.** 매년 열리는 수조 원 규모의 정부·지자체 창업지원, R&D, 정책자금 사업은 예비창업자와 초기 스타트업의 가장 중요한 성장 자원이지만, \"내게 맞는 공고를 찾는 일\"과 \"공고별 평가 기준에 맞춰 사업계획서를 작성하는 일\"은 창업자의 시간을 가장 많이 빼앗는 영역입니다. **genDOC**은 사업 아이템과 회사 정보를 입력하면 AI가 적합한 정부지원사업을 매칭하고, 평가 기준에 최적화된 사업계획서 초안을 자동으로 생성합니다. 멀티 에이전트 기반의 AI 심사위원·멘토 구조가 작성된 내용을 검토·보완하고, 실시간 웹 리서치로 시장·경쟁사 분석을 보강하며, 차트와 표가 포함된 .docx 결과물을 즉시 산출합니다. **핵심 기술** 지능형 공고 매칭 및 문맥 이해 기반 신청 문서 자동 작성 시스템 **(특허 출원, 2026)** AI 기반 맞춤형 공고 추천 및 문서 자동",
    ...
    "techEvidence": "LLM, 에이전트, 시장조사, 리서치, 경쟁사, MVP, 분석, 자동화",
    "priceText": [
      "100 크레딧 / CREDIT_TOKEN / 10,000원"
    ],
    "minPrice": 10000,
    "pricingKind": "usage",
    "pricingSortRank": 2,
    ...
    "services": [
      ...
      },
      {
        ...
        "techEvidence": "LLM, 에이전트, 리서치, 경쟁사, 분석, 자동화"
      }
    ]
  },
  {
  ...
  },
  {
    ...
    "summary": "엑셀 대신, 코딩 없이, 직접 업무에 맞게 만드는 데이터 플랫폼 - 데이터 통합관리 솔루션",
    "description": "**“내가 직접 만든, 우리 팀만의 WORK OS”** 🚀**주식회사 펀셰어**는 기업의 다양한 업무와 데이터를 하나로 연결하여 우리 조직에 꼭 맞는 업무 시스템을 직접 만들 수 있는 **AI 기반 Work OS 플랫폼을 제공**합니다. 🧩 **모든 업무를 하나의 시스템에서** **프로젝트 관리, 일정 관리, 인사 관리, 재무 관리, 현장 운영 등** 흩어져 있는 업무를 하나의 플랫폼에서 통합 관리할 수 있습니다. 🛠️**드래그 앤 드롭으로 완성하는 업무 시스템** 복잡한 개발 없이도 **드래그 앤 드롭 방식의 노코드(No-Code)** 환경으로 업무 화면과 협업 프로세스를 손쉽게 구성할 수 있습니다. 🤖 **AI 기반 업무 자동화** 반복 업무는 자동화하고, 데이터는 실시간으로 연결하여 더 빠르고 효율적인 업무 환경을 제공합니다. 🔗 **우리 조직에 맞게 자유롭게** 어떤 업무 데이터도, 어떤 협업 흐름도 우리 팀의 방식에 맞게 직접 만들고",
  ...
  },
  {
    ...
    "summary": "서버? 백엔드? 하나도 몰라도 괜찮아요! 원클릭 배포를 할 수 있습니다. 한국형 클라우드 배포 플랫폼 - GitHub 연결만으로 AI가 자동 배포하고, 보안·성능·UX까지 점검해주는 한국형 클라우드 플랫폼",
    "description": "솔루션이 너무 많아서 선택에 어려움이 있으시지요? 여러분의 선택에 도움을 드리고자 **미니 서비스**를 만들었습니다. 여러분에게 맞는 솔루션을 금방 찾아보세요! [https://modoo-solutions-rknc.somsatang.cloud/?ref=modoo-solution-company-list](https://modoo-solutions-rknc.somsatang.cloud/?ref=owner) AI 시대에는 창업에 대한 접근 방식이 달라져야 합니다. 인공지능 경진대회 최우수상 수상, 벤처기업 인증, 현대자동차그룹 AI 솔루션 개발 프로젝트 수행 등 다수의 프로젝트와 서비스를 성공적으로 운영한 노하우를 바탕으로, **창업자에게 가장 필요한 서비스**를 만들었습니다. 2020 **인공지능경진대회 최우수상 수상** 2021 **창업성장연구개발사업 선정** 2023 **글로벌소셜벤처경연대회 최우수상** 2024 **인공지능경진대회 최우수상 수상** 2025 **벤",
    ...
    "techEvidence": "바이브코딩, 자동화, 데이터베이스, 서버, 인프라, 클라우드",
    "priceText": [
  ...
  },
  {
    "id": 694,
    "name": "주식회사 루모스",
    "logo": "https://xgsaqqpairap3855818.gcdn.gov-ntruss.com/image/service/168311/06537bec69134374a1de8c682c2b2210.png",
    "summary": "루모스 AI 기반 맞춤형 지원사업 검색",
    "description": "**정부지원사업 탐색부터 성공 판정까지 AI Agent 루모스 ─ 100억 지원금 로드맵** **지원사업은 서류 몇 장 쓴다고 끝나는 게 아닙니다.** 창업자와 사업 본질에 대한 이해를 바탕으로 **지원사업 탐색 → 신청 → 사업비 집행 → 사업 수행 → 목표달성** 까지 전 과정의 로드맵을 짜고 들어가야 합니다. 기술기업이라면 — **TIPS부터 딥테크 · 스케일업 · 글로벌 · 연계사업까지** 사업성이 자신 있다면 — **LIPS부터 수출바우처 · 업종별 보조사업까지** **최대 100억 지원금 로드맵,** **국내 유일 지원사업 전 주기 AI Agent 루모스와 함께하세요.** 루모스는 지원사업 시장 문제를 AI AGENT로 해결하는 국내 유일의 스타트업입니다 ✓ **중기부 Opendata x AI 챌린지 우승** — AI 기반 맞춤형 지원사업 추천 부분 우승 ✓ **LIPS2 사업 공식 납품** — LIPS2 보조사업 수행기업 전부가 루모스 사용 ✓ **과기부",
    "website": "https://modoo.lumos-app.com/#1",
    "email": "jin@llumos.co",
    "contact": "",
    "sourceUrl": "https://www.modoo.or.kr/ai-solution/organization/694",
    "sectors": [
      "경영관리"
    ],
    "serviceNames": [
      "루모스 AI 기반 맞춤형 지원사업 검색",
      "루모스 AI 연구개발계획서 초안 작성",
      "루모스 AI 재무 & 국가사업비 관리"
    ],
    "majorTags": [
      "사업계획서/IR",
    ...
    "techEvidence": "홈페이지, 검색",
    "priceText": [
      "베이직 요금제 / CREDIT_TOKEN / 100,000원",
      "베이직 요금제 / CREDIT_TOKEN / 300,000원"
    ],
    "minPrice": 100000,
    "pricingKind": "usage",
    "pricingSortRank": 2,
    "benefits": [],
    "recommendation": "사업계획서, 홈페이지 결과물로 첫 고객 반응을 빠르게 확인하려는 루모스 AI 기반 맞춤형 지원사업 검색 같은 서비스가 필요한 팀",
    "followerCount": 15,
    "likeCount": 23,
    "hasFreeBenefit": false,
    "hasPrice": true,
    ...
    "services": [
      ...
      {
        "id": 1243,
        "name": "루모스 AI 연구개발계획서 초안 작성",
        "summary": "합격과 사업비 집행, 과제 성공까지 고려한 AI 연구개발계획서 생성기",
        "website": "https://modoo.lumos-app.com/#1",
        "keywords": [
          "R&D",
          "국가R&D",
      ...
      {
        "id": 1244,
        "name": "루모스 AI 재무 & 국가사업비 관리",
        "summary": "AI 기반 재무관리 및 국가사업비 관리 - 최적의 재무관리와 사업비 집행을 한번에",
        "website": "https://modoo.lumos-app.com/#1",
        "keywords": [
          "런웨이",
          "사업비",
  ...
  },
  {
    ...
    "pricingSortRank": 1,
    "benefits": [],
    "recommendation": "SNS/광고 문구, 랜딩페이지 결과물로 첫 고객 반응을 빠르게 확인하려는 MubloBiz 같은 서비스가 필요한 팀",
    "followerCount": 9,
    "likeCount": 27,
    "hasFreeBenefit": false,
    "hasPrice": true,
  ...
  },
  {
    "id": 735,
    "name": "주식회사 에이아이브",
    "logo": "https://xgsaqqpairap3855818.gcdn.gov-ntruss.com/image/service/199433/456ec1d060394142825d641e47d21c1d.png",
    "summary": "클릭 한번으로 끝내는 컨테이너 배포, 가장 비용 효율적인 클라우드",
    "description": "**AIEEV** AI Equality, Everyone's Value 에이아이브는 전세계에서 가장 비용 효율적인 AI 클라우드 기업을 목표로, 완전 분산형 GPU 클라우드 환경을 기반으로 한 서비스를 제공합니다.",
    ...
    "techEvidence": "인프라, GPU, 클라우드, AI 모델, API",
    "priceText": [
    ...
    "pricingSortRank": 0,
    "benefits": [
      "회원가입 이벤트: 회원가입 시 10,000AU 무료 제공",
      "회원가입 이벤트: 회원가입 시 10,000AU 즉시 제공"
    ],
    "recommendation": "DB/인프라, LLM/생성형AI 기술 방식을 활용해 아이디어를 제품 형태로 보여줘야 하는 Air Container 같은 서비스가 필요한 팀",
    "followerCount": 9,
    "likeCount": 24,
    "hasFreeBenefit": true,
    "hasPrice": true,
    ...
    "services": [
      {
        ...
        "name": "Air Container",
        "summary": "클릭 한번으로 끝내는 컨테이너 배포, 가장 비용 효율적인 클라우드",
        "website": "https://docs.aieev.com/docs/ko/air-container",
        "keywords": [
          "AI",
          "AI서비스",
          "AI인프라",
        ...
        "techEvidence": "인프라, GPU, 클라우드"
      },
      {
        "id": 1298,
        "name": "Air API",
        "summary": "인프라 관리 없이 AI 모델을 즉시 호출·테스트할 수 있는 API 기반 워크로드",
        ...
        "techEvidence": "AI 모델, API, 인프라, GPU, 클라우드"
      }
    ]
  },
  {
  ...
  },
  {
    ...
    "pricingSortRank": 2,
    "benefits": [
      "1,000 크레딧 무료제공: 서비스 내 원하는 기능을 사용해볼 수 있어요."
    ],
    "recommendation": "기술·개발 분야의 아이디어 검증 단계에서 사업계획서, IR/발표자료 근거가 필요한 무료 혜택까지 함께 확인하고 싶은",
    "followerCount": 14,
    "likeCount": 17,
  ...
  },
  {
    ...
    "techEvidence": "생성형, 에이전트, 검색, 분석, 보고서",
    "priceText": [
      "베이직 요금제 / 월 구독 / 30,000원"
    ],
    "minPrice": 30000,
    ...
    "pricingSortRank": 1,
    "benefits": [
      "기술로드맵 에이전트 사용: 중기부 중소기업 기술로드맵 보고서 기반 기술로드맵 적합성 자동 검토"
    ],
    "recommendation": "경영·관리 분야의 아이디어 검증 단계에서 리포트 근거가 필요한 무료 혜택까지 함께 확인하고 싶은",
    "followerCount": 13,
    "likeCount": 16,
    "hasFreeBenefit": true,
    "hasPrice": true,
    ...
    "services": [
      {
        ...
        "name": "랩투월드(Lab2World)",
        "summary": "사업화 아이템에 대한 연구동향 및 기술고도화 전략, 사업화 이슈를 자동 분석 및 검토하는 기술사업화 인텔리전스 솔루션",
        "website": "https://www.weinteract.co/Service",
        "keywords": [
          "기술고도화 전략수립",
          "기술사업화 전략",
          "사업화 이슈 분석",
  ...
  },
  {
    ...
    "logo": "https://xgsaqqpairap3855818.gcdn.gov-ntruss.com/image/service/188356/1de1a97a04c1417e949917f97123a803.png",
    ...
    "techEvidence": "AI 에이전트, 에이전트, 시제품, 보고서, 자동화",
    "priceText": [
    ...
    "pricingSortRank": 1,
    "benefits": [],
    "recommendation": "AI 에이전트, MVP/프로토타입 기술 방식을 활용해 아이디어를 제품 형태로 보여줘야 하는 EZ-Approve 같은 서비스가 필요한 팀",
    "followerCount": 13,
    "likeCount": 15,
    "hasFreeBenefit": false,
    "hasPrice": true,
  ...
  {
    "id": 779,
    "name": "가설검증, MVP로 도와드립니다 - 주식회사 코그니랩스",
    "logo": "https://xgsaqqpairap3855818.gcdn.gov-ntruss.com/image/service/101319/81d71206c9534d6e9839e014467c8c7a.webp",
    "summary": "아이디어 입력을 하면 시스템으로 구현해 드림 - MVP 자동 구현 시스템 : 기획부터 실서버 배포까지, 단 2개월. AI가 만드는 진짜 동작하는 시스템 - PPT가 아닌, 직접 써 볼 수 있는 MVP로 시장과 심사자를 설득하세요.",
    "description": "***“아이디어만 있으면, 웹으로 보여줄 수 있습니다.”*** *주식회사 코그니랩스는 창업자와 소상공인, 제조업체, 교육기관, 서비스 기업이 원하는 웹 결과물을 AI와 전문가의 협업으로 빠르게 구현하는 AI 웹 제작 솔루션 기업입니다.* **[ 회사 소개 ]** 주식회사 코그니랩스(CognyLabs)는 AI 기반 MVP 설계·구현 자동화 전문기업입니다. \"개발을 모르는 사람도 아이디어만 있으면 서비스를 만들 수 있어야 한다\"는 믿음으로 2024년 설립된 이후, 아이디어가 실제 서비스가 되기까지의 모든 과정을 AI로 자동화하는 일에 매진해 왔습니다. 기존에는 MVP 제작을 중심으로 소개되어 왔지만, 코그니랩스가 실제로 지원하는 범위는 훨씬 넓습니다. 창업 아이디어 검증용 MVP는 물론, 제품 상세페이지, 회사 소개 페이지, 제품 브로슈어, 서비스 랜딩페이지, 예약·문의 페이지, 교육 안내 페이지, 홍보용 웹페이지까지 만들 수 있습니다. **[ 우리가 잘하는 일 — MVP를",
    ...
    "techEvidence": "에이전트, 멀티에이전트, 노코드, 로우코드, 랜딩페이지, 랜딩, 웹페이지, MVP, 자동화, API",
    "priceText": [
    ...
    "services": [
      {
        ...
        "techEvidence": "에이전트, 멀티에이전트, 노코드, 로우코드, 랜딩페이지, 랜딩, 웹페이지, MVP, 자동화, API, 예약, DB"
      }
    ]
  },
  {
  ...
  },
  {
    ...
    "summary": "명함을 주는 순간, 관계가 AI로 이어지는 NFC디지털 명함 - “평소에는 사원증, 태그하는 순간 우리 팀을 소개하는 AI·NFC 비즈니스 명함 플랫폼 ‘터치미’”",
    "description": "**주식회사 겁쟁이사자들**은 2020년 창업 이래, 유수의 창업기업들과 협업하며 다양한 솔루션을 개발·납품해 왔습니다. 2025년에는 **NIPA 유망 SaaS 육성 사업**에 선정되어 자체 SaaS 솔루션을 고도화하고, **KACI**·**ISO 27001** 인증을 함께 확보했습니다. 저희 팀은 **예비창업패키지**와 **청년창업사관학교**를 이수하며 많은 창업기업들과 깊은 유대관계를 이어왔습니다. 저희가 다른 솔루션 기업과 결정적으로 다른 점은 단 하나입니다. **\"창업 서비스에 진심인 기업\"** 저희는 창업가의 시간과 마음을 진짜로 압니다. ────────────────────────────────────────── **DOIT — 대표와 팀의 하루를 묶는 협업툴** ────────────────────────────────────────── DOIT은 **\"개인의 행동과 삶과 일은 하나\"** 라는 모토로 만든 솔루션입니다. 스타트업은 **대표가 곧 회사**입니다.",
    ...
    "services": [
      ...
      },
      {
        "id": 1200,
        "name": "doit",
        "summary": "빠르게 실행하고 성장하는 팀을 위한 AI기반 타임 트래킹 솔루션 - \"스타트업 대표의 빈틈없는 하루부터 팀 협업까지 — AI가 분류하고 모두의 흐름이 실시간으로 보이는 솔루션\"",
  ...
  },
  {
    ...
    "summary": "고객 인터뷰, 멘토 피드백, 일정 관리를 한 곳에서 관리하세요 :)",
  ...
  },
  {
    ...
    "summary": "AI 기반 패션(의류) 디자인 SaaS 통합 솔루션 - AI 기반 작업지시서·도식화·의류 CAD 자동화 SaaS로 패션 디자인부터 생산까지 연결하는 올인원 플랫폼",
    "description": "**👕 Faddit (패딧)** **Fashion Design Editor, 디자인부터 생산까지 연결하는 패션 OS** **✨ About Faddit** 패딧은 패션 산업의 복잡하고 분산된 작업 방식을 더 쉽고, 빠르고, 직관적으로 바꾸기 위해 시작된 AI 기반 패션테크 팀입니다. 우리는 단순히 “작업지시서 툴”을 만드는 것이 아니라, 🧵 디자인 📐 패턴(CAD) 🪡 봉제 생산 📦 오더 관리 🎨 도식화 📁 파일 관리 💬 협업 커뮤니케이션 까지 이어지는 패션 생산 전 과정을 하나의 흐름으로 연결하는 플랫폼을 만들고 있습니다. **🚧 왜 패딧을 만들었나요?** 기존 패션 산업은 아직도 카톡으로 수정사항 전달, 엑셀로 사이즈 관리, 일러스트로 도식화 작업, 이메일로 파일 전달 , CAD는 별도 프로그램 사용, 생산 내용은 전화로 확인하는 구조가 많습니다. 결국 디자인과 생산 사이에서 수많은 커뮤니케이션 비용과 오류가 발생합니다. 패딧은 이 단절된 흐름을",
    "website": "",
    ...
    "techEvidence": "이미지 생성, 이미지, 전화, 자동화, 인프라",
    "priceText": [
    ...
    "recommendation": "이미지 생성, 음성/STT/TTS 기술 방식을 활용해 아이디어를 제품 형태로 보여줘야 하는 Faddit (패딧) 같은 서비스가 필요한 팀",
    "followerCount": 14,
    "likeCount": 9,
    "hasFreeBenefit": true,
    "hasPrice": true,
  ...
  },
  {
    "id": 772,
    "name": "주식회사 젠다이브",
    "logo": "https://xgsaqqpairap3855818.gcdn.gov-ntruss.com/image/service/193066/037537c29cac4991b959d4ced660cf5b.png",
    "summary": "최신 AI 모델(GPT Image 2, Happy Horse 1.0 등) 워크플로우로 반복생성부터 AI광고・마케팅/콘텐츠를 우리 제품/서비스를 홍보합니다.",
    "description": "젠다이브는 기업 실무자 대상으로 AX전환을 돕는 기업입니다. 텍스트∙이미지∙비디오∙오디오 등 최신 AI 모델을 AI 오케스트레이션 기술로 메모리까지 포함 된 실무자를 위한 AI 서비스 그 외 AI 학습 데이터 구축부터, AI 서비스 개발, AX전환 교육 등 비즈니스를 진행하고 있습니다. 팁스 / IBK창공 / 딥테크 청년창업사관학교 1기 선정 / 알리바바클라우드 AX파트너 등 다양한 이력을 보유하고 있습니다. 모두의 창업에 초기 스타트업이 필요한 모든 사항에 대해서 멘토부터 진행 가능합니다.",
    "website": "https://www.gendive.kr",
    "email": "mh.ham@gendive.ai",
    ...
    "techEvidence": "GPT, AI 모델, 이미지, 비디오, 자동화, 워크플로우, 클라우드",
    "priceText": [
    ...
    "pricingSortRank": 2,
    "benefits": [
      "✅ 회원가입 시 (텍스트 · 이미지 · 영상 · 오디오 · 자동화 등): 사용 가능한 1,000C 제공"
    ],
    "recommendation": "LLM/생성형AI, 이미지 생성 기술 방식을 활용해 아이디어를 제품 형태로 보여줘야 하는 데브다이브(devdive) 같은 서비스가 필요한 팀",
    "followerCount": 11,
    "likeCount": 10,
    "hasFreeBenefit": true,
    "hasPrice": true,
    ...
    "services": [
      {
        ...
        "name": "데브다이브(devdive)",
        "summary": "최신 AI 모델(GPT Image 2, Happy Horse 1.0 등) 워크플로우로 반복생성부터 AI광고・마케팅/콘텐츠를 우리 제품/서비스를 홍보합니다.",
        "website": "https://youtu.be/T5r5fkfFFb8?si=uE-9tML4SXhEUfG0",
        "keywords": [
          "AI Workflow",
          "AI광고",
          "AI영상생성",
  ...
  },
  {
    "id": 710,
    "name": "주식회사 블렌드엑스",
    "logo": "https://xgsaqqpairap3855818.gcdn.gov-ntruss.com/image/service/186536/79a2cfb0c30f42a38011f29bc034d41d.png",
  ...
  },
  {
    "id": 734,
    "name": "주식회사 아스타",
    "logo": "https://xgsaqqpairap3855818.gcdn.gov-ntruss.com/image/service/185210/2d051d03c97c4a28b33fed286599cfe9.png",
    "summary": "모스트(moast)에서 클릭 한번으로 메타, 네이버, 구글 등 광고 소재부터 제품 상세페이지를 생성하고 편집할 수 있어요!",
    "description": "엔터프라이즈 성장에 특화된 AI 전환 파트너, 아스타(Astar) 아스타는 기업의 실질적인 성장을 위한 Agentic AI & AX(AI Transformation) 솔루션을 개발하는 기업입니다. 단순한 AI 도입을 넘어, 기업의 업무 방식과 비즈니스 모델 전체를 AI 중심으로 혁신할 수 있도록 지원합니다.",
    "website": "https://www.astarcorp.ai/",
    "email": "support@astarcorp.ai",
    "contact": "010-4305-5839",
    ...
    "recommendation": "SNS/광고 문구 결과물로 첫 고객 반응을 빠르게 확인하려는 모스트 (moast) 같은 서비스가 필요한 팀",
    "followerCount": 9,
    "likeCount": 8,
    "hasFreeBenefit": true,
    "hasPrice": true,
  ...
  },
  {
    ...
    "summary": "1차 선정에 꼭 필요한 구조화 된 홈페이지 제작, 블로그 브랜딩, MVP까지직접 확장할 수 있는 창업자용 AI 브랜딩 플랫폼",
    ...
    "techEvidence": "Claude, 설문, 빌더, 바이브코딩, 랜딩, 홈페이지, MVP, 검색, 분석, 동영상",
    "priceText": [
    ...
    "services": [
      {
        ...
        "techEvidence": "Claude, 설문, 빌더, 바이브코딩, 랜딩, 홈페이지, MVP, 검색, 분석, 동영상, API, 예약"
      }
    ]
  },
  {
  ...
  },
  {
    ...
    "summary": "소상공인의 매장·상품 정보를 학습하여 24시간 다국어 고객상담과 맞춤형 안내를 제공하는 RAG 기반 AI 챗봇 서비스",
  ...
  },
  {
    ...
    "summary": "상품 URL이나 서비스 소개에 맞는 최적의 인플루언서를 찾아주고, 제안/일정 및 원고료 협상/업로드 성과까지 에이전트가 지원합니다",
  ...
  },
  {
    ...
    "priceText": [
      "m1.large VM : 4Core, 8GB, 40GB / CAPACITY_BASED / 172,800원"
    ],
    "minPrice": 172800,
    "pricingKind": "usage",
    "pricingSortRank": 2,
  ...
  },
  {
    ...
    "summary": "▶▶▶2차 라운드 합격 희망하시는 분들은 보세요! 모두 도와드립니다! 에어블로그(AirBlog)는 AI 기반 블로그 콘텐츠 제작 및 마케팅 자동화 솔루션입니다.",
    "description": "▶▶▶2차 라운드 합격 희망하시는 분들은 보세요! 모두 도와드립니다! ㈜스마트동스쿨은 AI 교육, AI기반 콘텐츠 제작, 디지털 마케팅 및 운영 서비스를 전문으로 하는 기업입니다. 다양한 정부지원사업 수행 경험과 온라인 플랫폼 운영 노하우를 바탕으로 예비창업자와 초기 창업기업이 빠르게 시장에 진입할 수 있도록 실질적인 디지털 솔루션을 제공합니다.",
    ...
    "techEvidence": "자동화, 영상제작, 동영상, 숏폼, 분석",
    "priceText": [
    ...
    "recommendation": "IR/발표자료, 블로그를 보강해 지원사업·IR 준비를 앞당기려는 팀",
    "followerCount": 3,
    "likeCount": 7,
    "hasFreeBenefit": true,
    "hasPrice": true,
    ...
    "services": [
      ...
      },
      {
        "id": 1152,
        "name": "튜브동스쿨",
        "summary": "▶▶▶2차 라운드 합격 희망하시는 분들은 보세요! 모두 도와드립니다! 튜브동스쿨은 AI기반의 유튜브 및 숏폼 콘텐츠 제작, 영상 마케팅, 채널 운영 매칭을 지원하는 유튜브 캠페인 플랫폼입니다.",
        ...
        "techEvidence": "영상제작, 동영상, 숏폼"
      },
      {
        "id": 1153,
        "name": "도트 타이머 AI",
        "summary": "▶▶▶2차 라운드 합격 희망하시는 분들은 보세요! 모두 도와드립니다! 도트 타이머 AI는 사용자의 시간 사용 데이터를 AI가 분석하여 보다 효율적인 집중 전략을 제안합니다.",
    ...
    "services": [
      {
        ...
        "name": "레몬AI (LemonAI)",
        "summary": "글로벌 이커머스 시장 분석 리포트 솔루션 - AI 기반 글로벌 데이터 리포트를 통해 시장·소비자·상품 트렌드를 빠르게 분석합니다.",
        "website": "https://founderbrief.datriss.com/guide/login",
        "keywords": [
          "ai",
          "글로벌",
          "데이터리포트",
  ...
  },
  {
    ...
    "summary": "도전하는 창업자를 위한 AI 비서 : 내 사업 아이디어 진단부터 즉시 실행 전략까지! 매출로 가는 가장 빠른 길!",
    "description": "**💡 비즈니어스의 시작: \"비즈니스 기회의 평등화\"를 향하여** 안녕하세요, **벤처랩스**입니다. 저희는 1인 창업가의 든든한 동료이자, 창업가용 AI 비서 서비스인 '**비즈니어스(BizniUs)**'를 만들어가고 있습니다. 누구나 정보 격차나 기술적 장벽 없이, '나다운' 비즈니스를 현실로 구현할 수 있는 세상을 꿈꾸는 팀입니다. **🌍 개인 모두가 사업가가 되어야 생존 가능한 시대** 수많은 정보와 AI 툴이 넘쳐나는 시대지만, 핵심적인 정보와 도구는 여전히 소수의 전유물로 남아 있습니다. 그리고 그 격차는 우리가 생각하는 것보다 훨씬 빠르게 벌어지고 있죠. 기술이 발전할수록 역설적으로 '시작'은 더 어려워지고, 경영을 돕기 위한 이론들은 날로 복잡해지고 있습니다. 시시각각 변하는 시장의 흐름과 실패에 대한 두려움은 수많은 잠재적 혁신가들의 발걸음을 멈추게 합니다. 비즈니어스는 바로 이러한 아이러니한 현상을 마주하며, 문제의 근본적인 해결책이 무엇인지에 대",
    ...
    "pricingSortRank": 1,
    "benefits": [
      "Free 요금제: 정교한 AI 분석, 우선 3회 체험으로 그 가치를 확인해 보세요."
    ],
    "recommendation": "MVP/프로토타입, 데이터 분석/대시보드 기술 방식을 활용해 아이디어를 제품 형태로 보여줘야 하는 비즈니어스 같은 서비스가 필요한 팀",
    "followerCount": 5,
    "likeCount": 3,
    "hasFreeBenefit": true,
    "hasPrice": true,
  ...
  },
  {
    ...
    "summary": "창업팀을 위한 AI 문서작성·지식관리 워크스페이스",
    ...
    "services": [
      {
        ...
        "summary": "교육, 상담, 면접, 서비스, 훈련 분야에 적용 가능한 멀티모달 AI 인터랙티브 휴먼",
        "website": "https://mindvrcreate-production.up.railway.app/",
        "keywords": [
          "AI",
          "교육",
          "마케팅",
  ...
  },
  {
    ...
    "pricingSortRank": 1,
    "benefits": [
      "무료 대시보드 조회(1달): 진행하는 광고를 연동하여 통합으로 볼 수 있는 기능"
    ],
  ...
  },
  {
    ...
    "summary": "수천 개의 지원사업 공고를 직접 찾을 필요 없습니다. 파트너잇은 기업 정보를 기반으로 선정 가능성이 높은 지원사업을 추천하고, 성장 단계에 맞는 기회를 연결하여 창업자의 시간과 비용을 절감합니다.",
    "description": "\"1개월 동안 눈에 보이는 성과를 만들 수 있는 AI\" 창업자의 시간을 아끼고, 기회를 늘리는 AI 솔루션, 파트너잇 좋은 아이디어가 있어도 어떤 지원사업을 신청해야 할지 몰라 기회를 놓치는 창업자가 많습니다. 파트너잇은 예비, 초기창업자의 현 상황에 가장 적합한 지원사업, 창업경진대회, 액셀러레이팅 프로그램 등 을 AI가 분석하여 추천합니다. 기업 정보를 기반으로 선정 가능성이 높은 지원사업들을 매칭하고, 성장 단계에 맞는 기회를 연결하여 창업자의 시간과 비용을 절감합니다.",
    "website": "https://partnerit.kr/",
    ...
    "services": [
      {
        ...
        "summary": "코딩 없이 자연어 한 줄로 나만의 AI 업무 자동화 에이전트를 만들 수 있어요",
        "website": "https://bctone-71574429.mintlify.app/guide",
        "keywords": [
          "AI 자동화",
          "AI 플랫폼",
          "노코드 에이전트",
  ...
  },
  {
    ...
    "pricingSortRank": 1,
    "benefits": [],
    "recommendation": "경영관리 분야의 아이디어 검증 단계에서 영상, 이미지 근거가 필요한 초기 창업팀",
    "followerCount": 5,
    "likeCount": 0,
    "hasFreeBenefit": false,
    "hasPrice": true,
  ...
  },
  {
    ...
    "serviceNames": [
      "민감 정보 프록시 토큰화 기반 AI 멀티 에이전트 기업 자문 플랫폼"
    ],
    "majorTags": [
      "기타/확인필요"
    ],
    ...
    "pricingSortRank": 3,
    "benefits": [],
    "recommendation": "민감 정보 프록시 토큰화 기반 AI 멀티 에이전트 기업 자문 플랫폼 같은 서비스가 필요한 예비창업자와 초기 팀",
    "followerCount": 4,
    "likeCount": 1,
    "hasFreeBenefit": false,
    "hasPrice": false,
    ...
    "services": [
      {
        "id": 1160,
        "name": "민감 정보 프록시 토큰화 기반 AI 멀티 에이전트 기업 자문 플랫폼",
        "summary": "",
        "website": "",
        "keywords": [],
        "priceText": [],
  ...
  },
  {
    ...
    "pricingSortRank": 3,
    "benefits": [],
    "recommendation": "Rooty 같은 서비스가 필요한 예비창업자와 초기 팀",
    "followerCount": 2,
    "likeCount": 2,
    "hasFreeBenefit": false,
    "hasPrice": false,
  ...
  },
  {
    ...
    "summary": "프로덕트 소개 자료, 사내 교육 자료 등 다양한 인터랙티브 교육 콘텐츠를 만드는 AI 솔루션",
  ...
  },
  {
    "id": 816,
    "name": "주식회사 헥사아이",
    "logo": "https://xgsaqqpairap3855818.gcdn.gov-ntruss.com/image/service/2458/1e17c3d323cc4b4d95fdd29a597a8769.png",
    "summary": "대화형 창업 사업계획 수립 및 수행 지원 코파일럿-대화를 통해 사업계획을 구체화 하고, 실행계획 수립, IR 까지 만들어볼 수 있어요.",
    "description": "",
    "website": "",
    ...
    "recommendation": "IR/발표자료를 보강해 지원사업·IR 준비를 앞당기려는 팀",
    "followerCount": 2,
    "likeCount": 1,
    "hasFreeBenefit": true,
    "hasPrice": true,
  ...
  },
  {
    "id": 622,
    "name": "모프트에이아이 주식회사",
    "logo": "https://xgsaqqpairap3855818.gcdn.gov-ntruss.com/image/service/111666/c3c5eb817c7a423f9f60679fae2abc89.png",
    "summary": "기자 탐색, 기업·미디어 분석, 피치 초안 작성, 발송 운영, 답장 관리, 리포트 기능을 통합한 AI 기반 PR·경영관리 솔루션",
    "description": "모프트에이아이 주식회사는 기업의 업무 효율화와 의사결정 고도화를 위한 AI 솔루션을 개발하는 기술기업입니다. 당사는 생성형 AI, 업무 자동화, 데이터 분석, 콘텐츠 생성 기술을 기반으로 기업이 반복적으로 수행하는 업무를 더 빠르고 체계적으로 처리할 수 있도록 돕습니다. 특히 PR·마케팅·경영관리 영역에서 발생하는 정보 탐색, 문서 작성, 고객 및 이해관계자 커뮤니케이션, 운영 리포트 작성 등의 업무를 AI 기반 워크플로우로 전환하는 데 집중하고 있습니다. 대표 솔루션인 pressor.ai는 기자 탐색, 기업·미디어 분석, 피치 초안 작성, 발송 운영, 답장 관리, 리포트 기능을 통합한 AI 기반 PR·경영관리 솔루션입니다. 이를 통해 기업은 단순한 자동화 도구를 넘어, 실무자가 검토하고 승인하는 방식의 안전한 AI 운영 체계를 구축할 수 있습니다. 모프트에이아이는 AI를 단순 기능이 아닌 실제 업무 프로세스 안에 적용하는 AI-native 솔루션 개발사를 지향합니다. 앞으로도",
    ...
    "techEvidence": "생성형, 데이터 분석, 분석, 리포트, 자동화, 워크플로우",
    "priceText": [
    ...
    "recommendation": "LLM/생성형AI, 데이터 분석/대시보드 기술 방식을 활용해 아이디어를 제품 형태로 보여줘야 하는 PRESSOR.AI 같은 서비스가 필요한 팀",
    "followerCount": 1,
    "likeCount": 1,
    "hasFreeBenefit": true,
    "hasPrice": true,
  ...
  },
  {
    ...
    "summary": "AI Work Operating SaaS - AI 기반 창업 실행 및 인력 운영 자동화 시스템) - 30분내 연결되는 협업인력 매칭 시스템, 관리 및 비용 정산까지 One-Stop Service.",
    "description": "실시간 재택근로자 매칭 및 관리 플랫폼 이지태스크입니다. 누구나 원할 때 , 원하는 사람과 협업 하며 상호 성장 할 수 있도록 지원하고 있습니다. 마케팅, 디자인, 행정, 회계, 홍보 등 모든 영역에서 10분단위로 일을 맡기실 수도 있고 정기매칭을 통해 지속적인 협업도 가능합니다. 인력 채용 및 관리에 드는 시간과 에너지를 최소화 하고 사업에 실행력을 더할 수 있습니다.",
    "website": "",
    "email": "terry04@hanmail.net",
    "contact": "",
    ...
    "recommendation": "사업계획서, 자동화를 보강해 지원사업·IR 준비를 앞당기려는 팀",
    "followerCount": 1,
    "likeCount": 0,
    "hasFreeBenefit": true,
    "hasPrice": true,
  ...
  },
  {
    ...
    "pricingSortRank": 3,
    "benefits": [],
    "recommendation": "The company doctor AI 같은 서비스가 필요한 예비창업자와 초기 팀",
    "followerCount": 1,
    "likeCount": 0,
    "hasFreeBenefit": false,
    "hasPrice": false,
  ...
  },
  {
    ...
    "name": "버즈앤비 주식회사",
    "logo": "",
    "summary": "생성형 AI 기반 유튜버 마케팅 특화 에이전트",
    "description": "",
    "website": "",
    ...
    "techEvidence": "생성형, 에이전트, 대시보드",
    "priceText": [],
    "minPrice": null,
    "pricingKind": "unknown",
    "pricingSortRank": 3,
    "benefits": [],
    "recommendation": "Agent-V 같은 서비스가 필요한 예비창업자와 초기 팀",
    "followerCount": 1,
    "likeCount": 0,
    "hasFreeBenefit": false,
    "hasPrice": false,
  ...
  },
  {
    ...
    "name": "주식회사 띵킹프렌즈",
    "logo": "",
    "summary": "복잡한 코딩 없이 JSON 하나로 배포하는 완전 관리형(SaaS) AI 에이전트 플랫폼",
    "description": "",
    "website": "",
    ...
    "techEvidence": "AI 에이전트, 에이전트",
    "priceText": [],
    "minPrice": null,
    "pricingKind": "unknown",
    "pricingSortRank": 3,
    "benefits": [],
    "recommendation": "TaskTeam 같은 서비스가 필요한 예비창업자와 초기 팀",
    "followerCount": 1,
    "likeCount": 0,
    "hasFreeBenefit": false,
    "hasPrice": false,
  ...
  },
  {
    ...
    "serviceNames": [
      "옴니 데이터 기반의 개인화된 사이즈•핏 해석을 제공하는 패션 이커머스 구매 의사결정 AI 서비스"
    ],
    "majorTags": [
      "데이터/리포트"
    ],
    ...
    "pricingSortRank": 3,
    "benefits": [],
    "recommendation": "리포트 기반으로 의사결정 자료를 확보하려는 팀",
    "followerCount": 0,
    "likeCount": 1,
    "hasFreeBenefit": false,
    "hasPrice": false,
    ...
    "services": [
      {
        "id": 1462,
        "name": "옴니 데이터 기반의 개인화된 사이즈•핏 해석을 제공하는 패션 이커머스 구매 의사결정 AI 서비스",
        "summary": "",
        "website": "",
        "keywords": [],
        "priceText": [],
